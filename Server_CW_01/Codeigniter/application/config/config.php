...
$config['base_url'] = 'http://localhost/Server_CW/Server_CW_01/Codeigniter/';
...
|
*/
$config['encryption_key'] = 'e74cef245507e5d76bc73014b8421a4d';       //*********************************************************************************************888 */
...
$config['sess_cookie_name'] = 'alumin_session';
$config['sess_samesite'] = 'Lax';
$config['sess_expiration'] = 1800; // 30 minutes (1800 seconds) of inactivity will cause the session to expire. Adjust as needed.
$config['sess_save_path'] = 'ci_sessions'; // This is the name of the database table where sessions are stored. Make sure to create this table using the appropriate migration.

<?php
// Codeigniter/application/views/auth/resend_verification.php
...
<head>
    ...
    <title>Resend Verification - Alumni Dashboard</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .logo-icon {
            ...
            background: linear-gradient(135deg, #0dcaf0, #0f3460);
            border-radius: 50%;
            display: flex; align-items: center; justify-content: center;
            margin: 0 auto 15px;
        }
        .logo-icon i { font-size: 30px; color: white; }
        .auth-logo h2 { color: #0f3460; font-weight: 700; font-size: 22px; margin-bottom: 5px; }
        ...
        .btn-resend:hover { opacity: 0.9; color: white; }
...
<div class="auth-wrapper">
    <div class="auth-card">
        ...
        <?php else: ?>
            ...
            <?php echo form_open('auth/resend_verification_submit'); ?>
